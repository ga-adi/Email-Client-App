...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    //TODO - put this in a singleton class instead?
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SharedPreferences settings = getSharedPreferences("com.example.charlie", Context.MODE_PRIVATE);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                //TODO - launch create a new email page here
                ...
                if (resultCode == RESULT_OK && data != null &&
                    ...
                    if (accountName != null) {
                        ...
                        SharedPreferences settings =
                                getSharedPreferences("com.example.charlie", Context.MODE_PRIVATE);
